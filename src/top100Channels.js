...
export default function top100Channels(videos) {
    const map = {};

    for (const video of videos) {
        try {            
            const { time, title, subtitles, titleUrl } = video;
            ...
            const id = url.split("https://www.youtube.com/channel/")[1];
